...
class MenuHelper
{
    ...
    public static function getIconSvg($iconName)
    {
        $icons = [
            ...
            'video' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15 10L19.5 7.5C20.1667 7.12963 21 7.61195 21 8.37799V15.622C21 16.388 20.1667 16.8704 19.5 16.5L15 14M5 18H13C14.1046 18 15 17.1046 15 16V8C15 6.89543 14.1046 6 13 6H5C3.89543 6 3 6.89543 3 8V16C3 17.1046 3.89543 18 5 18Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',            

            'customers' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M16 19C16 16.7909 14.2091 15 12 15H8C5.79086 15 4 16.7909 4 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><circle cx="10" cy="8" r="3" stroke="currentColor" stroke-width="1.5"/><path d="M20 19C20 17.3431 18.6569 16 17 16" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M15 5.13086C16.7252 5.57006 18 7.13616 18 9.00003C18 10.8639 16.7252 12.43 15 12.8692" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>',
